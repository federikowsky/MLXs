"""Interactive CLI chat with prompt-toolkit shell, streaming output, and prompt-cache reuse."""
...
class _InteractiveChatController:
    ...
    def __init__(self, deps: Dependencies, gen_opts: GenerateOptions, model_id: str) -> None:
        self._deps = deps
