...
Supports fused QKV projection, SwiGLU, SuScaledRoPE, and partial rotary.
"""
...
from mlxs.models.rope import SuScaledRoPE
...
class Attention(nn.Module):
    """Multi-head attention with fused QKV and optional SuScaledRoPE."""
...
class Model(nn.Module):
    """Phi-3 LM head wrapper — satisfies ModelProtocol."""
