"""Mamba2 state-space model — port from mlx_lm, ModelProtocol-compliant."""
...
from mlxs.cache.attention_mask import create_ssm_mask
...
class ModelArgs(BaseModelArgs):
    ...
    time_step_limit: tuple[float, float] = (0.0, 1e4)
...
class Mamba2Block(nn.Module):
    def __init__(self, args: ModelArgs, layer_idx: int) -> None:
        ...
        self.ssm_state_size = args.ssm_state_size or args.state_size
...
class Mamba2(nn.Module):
    ...
    def __call__(
        ...
        mask = create_ssm_mask(hidden, cache[0] if cache else None)
...
class Model(nn.Module):
    ...
    def __call__(
        ...
        *,
        ...
        hidden = self.backbone(input_ids, cache)
