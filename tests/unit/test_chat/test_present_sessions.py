...
from mlxs.chat.present.sessions import empty_session_list_fragments, item_from_summary, items_from_summaries
...
def test_item_from_summary_builds_title_meta_and_search_text() -> None:
    ...
    assert item.meta == "3 messages · 2026-04-12T12:00:00+00:00"
