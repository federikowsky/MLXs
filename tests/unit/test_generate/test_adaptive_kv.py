...
def test_adaptive_enabled_standard_qwen35_hybrid_runtime_preserves_generation() -> None:
    ...
    assert "execution_view_local_repairs_total" in final_state[0]["attention_path"]
    assert "execution_view_repaired_suffix_tokens_total" in final_state[0]["attention_path"]
